...
export const RPC_ENDPOINTS: Record<NetworkName, string[]> = {
    'mainnet': [
        ...
        // 'https://mainnet-rpc.sui.chainbase.online',          // 567 response occasionally
        // 'https://sui-mainnet-rpc-germany.allthatnode.com',   // 429 too many requests
        // 'https://sui-mainnet-rpc-korea.allthatnode.com',     // 429 too many requests
    ...
    'testnet': [
        ...
        // 'https://sui-testnet.nodeinfra.com',                 // 429 too many requests
    ],
    'devnet': [
