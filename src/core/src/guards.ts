 ...
 */
export type ObjChangeKind<K extends ObjChangeKeys> = Extract<
	SuiObjectChange,
	{ type: K }
>;
 ...
 */
export type ParsedDataKind<K extends ParsedDataKeys> = Extract<
	SuiParsedData,
	{ dataType: K }
>;
 ...
 */
export function isTxKind<K extends TxKeys>(tx: SuiTransaction, kind: K): tx is TxKind<K> {
	return kind in tx;
}
