...
export class CoinMetaFetcher {
	...
	public async getCoinMeta(coinType: string): Promise<CoinMeta | null> {
	...
	public async getCoinMetas(coinTypes: string[]): Promise<Map<string, CoinMeta | null>> {
		const uniqueTypes = Array.from(
			new Set(coinTypes.map((coinType) => normalizeStructTag(coinType))),
		);
