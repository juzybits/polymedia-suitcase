...
describe("shortenAddress", () => {
	...
	it("should handle text with multiple addresses", () => {
		const text =
			"Transfer from 0x1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef to 0xabcdef1234567890abcdef1234567890abcdef1234567890abcdef1234567890";
	...
	it("should handle mixed content with addresses", () => {
		const text =
			"Check address 0x1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef and visit https://example.com";
	...
	it("should not match invalid hex characters", () => {
		...
		expect(shortenAddress(textWithInvalid)).toBe(
			"Valid: 0x1234…6789 Invalid: 0x123g567890abcdef",
		);
	});
