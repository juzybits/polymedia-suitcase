...
describe("formatBalance", () => {
	describe("standard format", () => {
		...
		it("should handle very large numbers", () => {
			expect(formatBalance(1234567890123456789012345678901234567890n, 0)).toBe(
	...
	describe("compact format", () => {
		...
		it("should handle numbers larger than maximum safe integer", () => {
			...
			expect(formatBalance(largeNumber, 0, "compact")).toBe(
				"1,234,567,890,123,456,789,012,345,678T",
			);
		});
